...
//o=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=o//
        ...
        val t: Thread = object: Thread() {
            override fun run() {
                ...
                try {
                    ...
                    //Configuramos la impresión como line_print
                    ...
                    //Imprimimos la cabecera de las líneas
                    texto = imprCabLin80CPCL()
                    os.write(texto.toByteArray())

                    //Imprimimos las líneas del documento (positivas y negativas)
    ...
    private fun imprDatClteDoc80CPCL(): String {
        ...
        //Imprimimos el código y el nombre del cliente
        ...
        //Imprimimos el código postal y la población del cliente
        ...
        //Imprimimos el código y el nombre del vendedor
        ...
        //Imprimimos el tipo de documento y el número (serie e identificador de ese documento)
...
//o=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=o//
    ...
    /*Esta función limpia los caracteres con acentos y las ñ*/
    ...
    private fun limpiarLetrasEspeciales(texto: String): String {
        ...
        textoReplace = textoReplace.replace('á','a', false)
        textoReplace = textoReplace.replace('é','e', false)
        textoReplace = textoReplace.replace('í','i', false)
        textoReplace = textoReplace.replace('ó','o', false)
