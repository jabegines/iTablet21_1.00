...
import kotlinx.android.synthetic.main.item_formatos_list.view.tvDescrFto


class FormatosRvAdapter(var formatos: MutableList<DatosVtaFtos>, val context: Context, var listener: OnItemClickListener): RecyclerView.Adapter<FormatosRvAdapter.ViewHolder>() {
