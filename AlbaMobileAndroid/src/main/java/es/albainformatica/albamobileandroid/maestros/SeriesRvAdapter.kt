...
class SeriesRvAdapter(var series: MutableList<DatosVtaSeries>, val context: Context,
                      var listener: OnItemClickListener): RecyclerView.Adapter<SeriesRvAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            listener.onClick(it, series[position])
        }
    }
    ...
    interface OnItemClickListener {
        fun onClick(view: View, data: DatosVtaSeries)
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(serie: DatosVtaSeries) {
            descripcion.text = serie.serie
        }
    }
